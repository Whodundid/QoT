package envision.debug.terminal.window;

import envision.debug.terminal.TerminalCommandHandler;
import envision.debug.terminal.window.termParts.TerminalTextField;
import envision.debug.terminal.window.termParts.TerminalTextLine;
