package envision.debug.terminal;
...
import envision.debug.terminal.commands.categories.engine.CMD_Config;
import envision.debug.terminal.commands.categories.engine.CMD_CurScreenInfo;
import envision.debug.terminal.commands.categories.engine.CMD_DebugControl;
import envision.debug.terminal.commands.categories.engine.CMD_DisplayScreen;
import envision.debug.terminal.commands.categories.engine.CMD_Envision;
import envision.debug.terminal.commands.categories.engine.CMD_FPS;
import envision.debug.terminal.commands.categories.engine.CMD_Help;
import envision.debug.terminal.commands.categories.engine.CMD_ReloadTextures;
import envision.debug.terminal.commands.categories.engine.CMD_SetVolume;
import envision.debug.terminal.commands.categories.engine.CMD_Shutdown;
import envision.debug.terminal.commands.categories.engine.CMD_TPS;
import envision.debug.terminal.commands.categories.engine.CMD_Version;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Cat;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Cd;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Cp;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Edit;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Head;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Ls;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Lsblk;
import envision.debug.terminal.commands.categories.fileSystem.CMD_MkDir;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Mv;
import envision.debug.terminal.commands.categories.fileSystem.CMD_OpenFile;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Pwd;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Rm;
import envision.debug.terminal.commands.categories.fileSystem.CMD_RmDir;
import envision.debug.terminal.commands.categories.fileSystem.CMD_Tail;
import envision.debug.terminal.commands.categories.game.CMD_CreateDungeon;
import envision.debug.terminal.commands.categories.game.CMD_God;
import envision.debug.terminal.commands.categories.game.CMD_Kill;
import envision.debug.terminal.commands.categories.game.CMD_ListEntities;
import envision.debug.terminal.commands.categories.game.CMD_LoadWorld;
import envision.debug.terminal.commands.categories.game.CMD_NoClip;
import envision.debug.terminal.commands.categories.game.CMD_PauseGame;
import envision.debug.terminal.commands.categories.game.CMD_PlaySong;
import envision.debug.terminal.commands.categories.game.CMD_ReloadWorld;
import envision.debug.terminal.commands.categories.game.CMD_SaveWorld;
import envision.debug.terminal.commands.categories.game.CMD_SetWorldUnderground;
import envision.debug.terminal.commands.categories.game.CMD_SpawnEntity;
import envision.debug.terminal.commands.categories.game.CMD_UnloadWorld;
import envision.debug.terminal.commands.categories.game.CMD_WorldInfo;
import envision.debug.terminal.commands.categories.game.CMD_WorldsDir;
import envision.debug.terminal.commands.categories.system.CMD_Calculator;
import envision.debug.terminal.commands.categories.system.CMD_ClearTerminal;
import envision.debug.terminal.commands.categories.system.CMD_ClearTerminalHistory;
import envision.debug.terminal.commands.categories.system.CMD_ForLoop;
import envision.debug.terminal.commands.categories.system.CMD_HexToDec;
import envision.debug.terminal.commands.categories.system.CMD_JavaTrace;
import envision.debug.terminal.commands.categories.system.CMD_List;
import envision.debug.terminal.commands.categories.system.CMD_ReregisterCommands;
import envision.debug.terminal.commands.categories.system.CMD_Runtime;
import envision.debug.terminal.commands.categories.system.CMD_System;
import envision.debug.terminal.commands.categories.system.CMD_WhoAmI;
import envision.debug.terminal.commands.categories.windows.CMD_ClearObjects;
import envision.debug.terminal.commands.categories.windows.CMD_CloseWindow;
import envision.debug.terminal.commands.categories.windows.CMD_ShowWindow;
import envision.debug.terminal.commands.categories.windows.CMD_MinimizeWindow;
import envision.debug.terminal.commands.categories.windows.CMD_MoveWindowToFront;
import envision.debug.terminal.commands.categories.windows.CMD_PinWindow;
import envision.debug.terminal.commands.categories.windows.CMD_TermID;
import envision.debug.terminal.commands.categories.windows.CMD_OpenWindow;
import envision.debug.terminal.terminalUtil.ClassFinder;
...
public class TerminalCommandHandler {
	...
	public static ETerminalWindow getActiveTerminal() {
		ETerminalWindow term = QoT.getTopRenderer().getTerminalInstance();
