...
public interface IWindowObject<E> extends KeyboardInputAcceptor, MouseInputAcceptor {
	...
	public default IWindowObject<E> resize(double xIn, double yIn, ScreenLocation areaIn) {
	...
	public default IWindowObject<E> setPosition(double newX, double newY) {
	...
	public default IWindowObject<E> setDimensions(EDimension dimIn) {
		return setDimensions(dimIn.startX, dimIn.startY, dimIn.width, dimIn.height);
	}
	/** Specifies this object's width and height based on the current starting position. */
	public default IWindowObject<E> setSize(double widthIn, double heightIn) {
		EDimension dims = getDimensions();
		return setDimensions(dims.startX, dims.startY, widthIn, heightIn);
	}
	...
	public default EArrayList<IWindowObject<?>> getAllChildren() { return StaticWindowObject.getAllChildren(this); }
	/** Returns a list of all children from 'getAllChildren()' that are currently under the mouse. */
	public default EArrayList<IWindowObject<?>> getAllChildrenUnderMouse() { return StaticWindowObject.getAllChildrenUnderMouse(this, Mouse.getMx(), Mouse.getMy()); }
	/** Returns true if the specified object is a child of the parent or is being added to the parent. */
	public default boolean containsObject(IWindowObject<?> object) { return getCombinedObjects().contains(object); }
	/** Returns true if the specified object type is a child of the parent or is being added to the parent. */
	public default boolean containsObject(Class objIn) { return objIn != null ? getAllChildren().stream().anyMatch(o -> objIn.isInstance(o)) : false; }
	...
	public default ITopParent<?> getTopParent() { return StaticWindowObject.getTopParent(this); }
	/** Returns the first instance of a WindowParent in the parent chain. */
	public default IWindowParent<?> getWindowParent() { return StaticWindowObject.getWindowParent(this); }
	...
	public default void drawFocusLockBorder() {
		if (checkDraw() && getObjects().containsNoInstanceOf(FocusLockBorder.class)) {
	...
	public default IWindowObject<E> requestFocus() { return requestFocus(FocusType.Transfer); }
	/** Same as the previous request focus but the exact type of focus event can be specified. */
	public default IWindowObject<E> requestFocus(FocusType typeIn) {
	...
	public default boolean isMouseOnEdge(int mX, int mY) {
		return checkDraw() && getEdgeSideMouseIsOn() != ScreenLocation.OUT;
	}
	...
	public default IWindowObject<E> setEntiretyClickable(boolean val) {
	...
	public default void setPersistent(boolean val, IWindowObject... objs) { setVal(o -> o.setPersistent(val), objs); }
	...
	public static void setPersistentS(boolean val, IWindowObject... objs) { setVal(o -> o.setPersistent(val), objs); }
