...
public class EventHandler {
	 ...
	 */
	public void addSubscriber(IEventListener subscriber, EventType eventToSubscribeOn) {
	 ...
	 * @param eventToSubscribeOn The event type the object wants to listen for
	 */
	public void unsubscribe(IEventListener subscriber, EventType eventToUnsubscribeOn) {
