package envision.engine.kernel.terminal.commands.categories.windows;
	...
	public void runCommand() {
	    ...
	    try {
            ...
            if (theWindow != null) {
                ...
                writeln("Window: [" + theWindow.getObjectName() + " | " + theWindow.getObjectID() + "] " + (!val ? "" : "un") + "minimized.", EColors.green);
            }
