package envision.engine.kernel.terminal.commands.categories.game;
...
public class CMD_TransposeOld extends TerminalCommand {
    ...
    @Override public void handleTabComplete(ETerminalWindow conIn, EList<String> args) {
        this.basicTabComplete(conIn, args, CurrentGame.getEditorWorldsDir().list());
    }
    ...
    public void runCommand() throws Exception {
        ...
        File worldDir = new File(CurrentGame.getEditorWorldsDir(), path);
