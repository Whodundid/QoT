...
public class GLCamera {
    ...
    public GLCamera() { this(0f, 0f, 20f); }
    public GLCamera(float x, float y) { this(new Vector3f(x, y, 20f)); }
    public GLCamera(float x, float y, float z) { this(new Vector3f(x, y, z)); }
    public GLCamera(Vec2f positionIn) { this(new Vector3f(positionIn.x, positionIn.y, 20f)); }
    public GLCamera(Vector3f positionIn) {
        position = positionIn;
