...
public class OrBlock extends FunctionBlock {
    ...
    public OrBlock() { this("Or"); }
    public OrBlock(String blockName) {
        super(blockName);
        
        output = createOutputPoint("Output", PointLocation.RIGHT);
        inputA = createInputPoint("Or-A", 1, PointLocation.LEFT);
        inputB = createInputPoint("Or-B", 1, PointLocation.LEFT);
