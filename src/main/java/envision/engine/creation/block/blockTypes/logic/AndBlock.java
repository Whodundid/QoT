package envision.engine.creation.block.blockTypes.logic;
...
public class AndBlock extends FunctionBlock {
    ...
    public AndBlock() { this("And"); }
    public AndBlock(String blockName) {
        super(blockName);
        
        output = createOutputPoint("Output", PointLocation.RIGHT);
        inputA = createInputPoint("And-A", 1, PointLocation.LEFT);
        inputB = createInputPoint("And-B", 1, PointLocation.LEFT);
    ...
    public void evaluate() {
        ...
        output.setValue(amount == inputPoints.size());
    }
