...
import envision.engine.registry.loaders.IResourceManager;
...
import envision.engine.registry.loaders.dto.WorldTileDTO;
...
public class TextureLoader implements IResourceManager {
	...
	private void loadTextureFile() {
		...
		try {
		    ...
		    toLoad.put(texture.name(), new GameTexture(Envision.getGameResourcesDirectory() + "/" + texture.path()));
