package envision.engine.internal.kernel.terminal;
...
import envision.engine.internal.kernel.terminal.commands.CommandResult;
import envision.engine.internal.kernel.terminal.commands.TerminalCommand;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_CameraZoom;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_Config;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_CurScreenInfo;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_DebugControl;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_DesktopControl;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_DisplayScreen;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_EditWorld;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_Envision;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_FPS;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_Font;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_LockCam;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_PlaySong;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_ReloadTextures;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_RenderSettings;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_SetVolume;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_TPS;
import envision.engine.internal.kernel.terminal.commands.categories.engine.CMD_Version;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Cat;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Cd;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Cp;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Edit;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Files;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Head;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_L;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Ls;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Lsblk;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_MkDir;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Mv;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_OpenFile;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Pwd;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Rm;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Source;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Tail;
import envision.engine.internal.kernel.terminal.commands.categories.fileSystem.CMD_Touch;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_CreateDungeon;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_GiveItem;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_God;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_KillEntity;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_ListEntities;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_LoadWorld;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_NoClip;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_PauseGame;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_ReloadWorld;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_Rules;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_SaveWorld;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_SetWorldUnderground;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_SetXP;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_SpawnEntity;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_Speed;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_Time;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_TransposeOld;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_UnloadWorld;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_WorldInfo;
import envision.engine.internal.kernel.terminal.commands.categories.game.CMD_WorldsDir;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Alias;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Calculator;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_ClearTerminal;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_ClearTerminalHistory;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Echo;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Exit;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_ForLoop;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Help;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_HexToDec;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_JavaTrace;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Kill;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_List;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_PS;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Profiler;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_ReregisterCommands;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Runtime;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_SU;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Shutdown;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_System;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Unalias;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_Watch;
import envision.engine.internal.kernel.terminal.commands.categories.system.CMD_WhoAmI;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_ClearObjects;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_CloseWindow;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_MinimizeWindow;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_MoveWindowToFront;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_OpenWindow;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_PinWindow;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_ShowWindow;
import envision.engine.internal.kernel.terminal.commands.categories.windows.CMD_TermID;
import envision.engine.internal.kernel.terminal.window.ETerminalWindow;
import envision.engine.internal.kernel.user.UserPermissionError;
...
public class TerminalCommandHandler {
    ...
    public boolean drawSpace = true;
    public EList<String> cmdHistory = EList.newList();    
    //==============
    // Constructors
    //==============
...
//    }
    ...
    private void registerBaseCommands(ETerminalWindow termIn, boolean runVisually) {
        ...
        registerCommand(new CMD_Font(), termIn, runVisually);
        ...
        registerCommand(new CMD_Touch(), termIn, runVisually);
        ...
        registerCommand(new CMD_KillEntity(), termIn, runVisually);
        ...
        registerCommand(new CMD_Exit(), termIn, runVisually);
        ...
        registerCommand(new CMD_Watch(), termIn, runVisually);
...
//            }
            ...
            lastResult = executeCommand(termIn, cmd, baseCommand, commandArguments, tab);
        }
        
        return lastResult;
    }
    
    public CommandResult executeCommand(ETerminalWindow termIn, String cmd, String commandName, EList<String> arguments) {
        return executeCommand(termIn, cmd, commandName, arguments, false);
    }
    public CommandResult executeCommand(ETerminalWindow termIn, String cmd, String commandName, EList<String> commandArguments, boolean tab) {
        // first, try to find a registered alias for the given command name
        final String foundAlias = commandAliases.get(commandName);
        
        EList<String> args = commandArguments;
        if (args == null) args = EList.newList();
        
        // if we have an alias, execute its replacement instead
        if (foundAlias != null && !foundAlias.startsWith(commandName)) {
            var aliasCommand = new EStringBuilder(foundAlias);
            aliasCommand.a(" ");
            aliasCommand.a(EStringUtil.combineAll(args, " "));
            return executeCommand(termIn, aliasCommand.toString(), tab);
        }
        
        // extract the associated command
        Box2<String, TerminalCommand> foundCommand = commands.getBoxWithA(commandName);
        
        if (foundCommand == null) {
            termIn.error("Unrecognized command.");
            if (EngineSettings.termCmdNewLines.getBoolean()) termIn.writeln();
            return null;
        }
        
        TerminalCommand command = foundCommand.getB();
        ...
        if (tab) {
            if (command.showInHelp()) command.handleTabComplete(termIn, args);
        }
        else {
            
            //-----------------------------------------------
            // create a process on the kernel and execute it
            //-----------------------------------------------
            
            UserProfile user = termIn.getActiveUser();
            command.preRun(termIn, args, runVisually);
            
            try {
                //Thread pThread;
                EnvisionKernel.getInstance().startProcess(user, cmd, command);
                //if (pThread != null) {
                //    pThread.join();
                //}
                result = command.getResult();
            }
            catch (UserPermissionError e) {
                termIn.error(e.getMessage());
            }
            catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if (!EngineSettings.termCmdNewLines.getBoolean()) {
                return result;
            }
    ...
    public TerminalCommand getRegisteredCommand(String commandName) {
        return getCommand(commandName);
    }
    
    public TerminalCommand tabCompleteCommand(String input) {
        if (input == null || input.isBlank()) return null;
        
        for (var cmd : getCommandList()) {
     ...
     */
    public EList<String> buildTabCompleteCommandOptions(String input) {
        ...
        for (String alias : getCommandAliases().keySet()) {
            if (alias.startsWith(input)) {
                returnList.add(alias);
            }
        }
    ...
    public EList<String> getSortedCommandNames(UserProfile profile) {
        EList<String> cmds = EList.newList();
        BoxList<String, EList<TerminalCommand>> sortedAll = getSortedCommands(profile);
    ...
    public BoxList<String, EList<TerminalCommand>> getSortedCommands(UserProfile profile) {
        ...
        for (var command : getCommandList()) {
            // only display command if the user has the permissions to even run it
            if (profile.getPermissionLevel() < command.requiredPermissionLevel()) continue;
    ...
    public void executeOnTerminal(ETerminalWindow termIn, String commandName, EList<String> arguments) {
        executeCommand(termIn, "", commandName, arguments);
    }
    
    public void executeOnTerminal(ETerminalWindow termIn, String commandName, EList<String> arguments, boolean tab) {
        executeCommand(termIn, "", commandName, arguments, tab);
    }
