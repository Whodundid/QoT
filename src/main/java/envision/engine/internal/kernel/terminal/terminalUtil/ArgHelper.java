package envision.engine.internal.kernel.terminal.terminalUtil;
...
public class ArgHelper {
    ...
    public EList<String> args() { return EList.of(arguments); }
    public EList<String> stringArgs() { return EList.of(groupedByString); }
