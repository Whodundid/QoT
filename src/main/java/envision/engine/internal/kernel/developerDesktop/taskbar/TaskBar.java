package envision.engine.internal.kernel.developerDesktop.taskbar;
...
public class TaskBar extends WindowObject {
    ...
    public static synchronized void windowOpened(IWindowParent window) {
//        System.out.println("ADDING: " + window);
        toAdd.add(window);
    }
    
    public static synchronized void windowClosed(IWindowParent window) {
//        System.out.println("CLOSING: " + window);
    ...
    public void onAdded() {
        ...
        var tp = getTopParent();
        tp.registerListener(this, WindowEventType.ADDED, WindowEventType.REMOVED, WindowEventType.CLOSED);
    }
...
//        if (e instanceof EventObjectAdded added) {
//            if (added.getTargetObject() instanceof IWindowParent) {
//                updateLists();
//            }
//        }
//        else if (e instanceof EventObjectRemoved removed) {
//            if (removed.getTargetObject() instanceof IWindowParent) {
//                updateLists();
//            }
//        }
//        else if (e instanceof EventObjectClosed closed) {
//            if (closed.getTargetObject() instanceof IWindowParent) {
//                updateLists();
//            }
//        }
    }
...
//                        p.bringToFront();
        ...
        try {
            ...
            for (TaskBarButton b : buttons) {
                if (!Envision.getDeveloperDesktop().isWindowOpen(b.getWindowType().getClass())) {
                    // TODO: I have no idea if this was actually doing anything!
    ...
    private void addButton(IWindowParent window) {
        //System.out.println(window.showInTaskBar());
