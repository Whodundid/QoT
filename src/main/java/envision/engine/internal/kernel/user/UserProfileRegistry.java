...
public class UserProfileRegistry {
    ...
    public static int getProfileColor(UserProfile profile) {
        return getProfileEColor(profile).intVal;
    }
    
    public static EColors getProfileEColor(UserProfile profile) {
        if (profile == null) return EColors.lred;
        else if (profile.getPermissionLevel() == (byte) 0) return EColors.lgray;
        else if (profile.getPermissionLevel() == (byte) 2) return EColors.purple;
        return EColors.aquamarine;
    }
