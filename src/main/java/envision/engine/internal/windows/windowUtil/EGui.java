...
public abstract class EGui extends RenderingManager implements KeyboardInputAcceptor, MouseInputAcceptor {
    ...
    public double drawStringC(Object obj) { return drawStringC(obj, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, 0xffffffff); }
    public double drawStringC(String str) { return drawStringC(str, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, 0xffffffff); }
    public double drawStringC(Object obj, EColors color) { return drawStringC(obj, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, color); }
    public double drawStringC(String str, EColors color) { return drawStringC(str, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, color); }
    public double drawStringC(Object obj, int color) { return drawStringC(obj, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, color); }
    public double drawStringC(String str, int color) { return drawStringC(str, midX, midY - FontRenderer.FONT_HEIGHT / 2 + FontRenderer.FH / 6, color); }
