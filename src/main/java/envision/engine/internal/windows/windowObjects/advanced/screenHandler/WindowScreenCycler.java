package envision.engine.internal.windows.windowObjects.advanced.screenHandler;
...
public class WindowScreenCycler extends ActionObject {
    ...
    public void showCurrent() {
        screens.executeOnObjectAtIndex(currentScreen, s -> { s.showScreen(); s.onLoaded(); });
    }
    
    public void hideCurrent() {
        screens.executeOnObjectAtIndex(currentScreen, s -> { s.hideScreen(); s.onUnloaded(); });
    }
    
    public void addScreen(WindowScreen... screensIn) {
        screens.addA(screensIn);
    }    
    //=========
    // Getters
    //=========
