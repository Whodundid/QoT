package envision.engine.internal.windows.windowObjects.advanced.colorPicker;

import envision.Envision;
import envision.engine.internal.settings.config.setting_types.IntegerConfigSetting;
import envision.engine.internal.windows.WindowRegistry;
...
import envision.engine.internal.windows.windowObjects.basic.WindowPanelWithTitle;
...
import envision.engine.internal.windows.windowObjects.utility.WindowDialogueBox.DialogBoxTypes;
import envision.engine.internal.windows.windowTypes.ActionWindowParent;
...
public class ColorPickerSimple extends ActionWindowParent {
    ...
    private ColorPickerButton white, chalk, plgray, lgray, gray, mgray, dgray, pdgray, lsteel, steel, dsteel, vdgray, black;
    ...
    public ColorPickerSimple(IWindowObject parentIn, IntegerConfigSetting setting) { this(parentIn, setting.getInt()); }
    ...
    public void initChildren() {
        ...
        WindowPanelWithTitle colorContainer = new WindowPanelWithTitle(this, startX + 5, colorDisplay.endY + 16, width - 10, 100);
        ...
        double y2 = navy.endY + 11;
        
        white = new ColorPickerButton(this, red.midX, y2, w, h, EColors.white);
        chalk = new ColorPickerButton(this, white.endX + 1, y2, w, h, EColors.chalk);
        plgray = new ColorPickerButton(this, chalk.endX + 1, y2, w, h, EColors.plgray);
        lgray = new ColorPickerButton(this, plgray.endX + 1, y2, w, h, EColors.lgray);
        ...
        WindowPanelWithTitle inputContainer = new WindowPanelWithTitle(this, startX + 5, colorContainer.endY + 6, width - 10, 107);
        ...
        colorContainer.addObject(white, chalk, plgray, lgray, gray, mgray, dgray, pdgray, lsteel, steel, dsteel, vdgray, black);
