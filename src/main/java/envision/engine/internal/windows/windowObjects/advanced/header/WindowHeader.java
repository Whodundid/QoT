package envision.engine.internal.windows.windowObjects.advanced.header;
...
public class WindowHeader extends WindowObject {
    ...
    public WindowHeader(IWindowObject parentIn, boolean drawDefaultIn, int headerHeight, String titleIn) {
        ...
        // make sure there is some kind of header title
        if (title == null) {
            title = "NO_NAME";
        }
    }    
    ...
    public void onDoubleClick() {
        if (window == null || !window.isMaximizable()) return;
