...
public class WindowSlider extends ActionObject {
    ...
    public void setSliderValue(IntegerConfigSetting setting) { setSliderValue(setting.getInt()); }
    public void setSliderValue(DoubleConfigSetting setting) { setSliderValue(setting.getDouble()); }
