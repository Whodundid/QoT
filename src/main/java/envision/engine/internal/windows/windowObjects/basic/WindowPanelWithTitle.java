...
public class WindowPanelWithTitle extends WindowObject {
    ...
    public WindowPanelWithTitle(IWindowObject parentIn, double xIn, double yIn, double widthIn, double heightIn) {
        this(parentIn, xIn, yIn, widthIn, heightIn, true);
    }
    
    public WindowPanelWithTitle(IWindowObject parentIn, double xIn, double yIn, double widthIn, double heightIn, boolean drawTitleIn) {
