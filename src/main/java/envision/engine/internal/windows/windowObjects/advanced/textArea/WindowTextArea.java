...
public class WindowTextArea<E> extends WindowScrollList<E> {
    ...
    @Override
    public synchronized void drawObject_i(float dt, int mXIn, int mYIn) {
    ...
    public TextAreaLine<E> addTextLine(String textIn, E objectIn) { return addTextLine(textIn, EColors.white, objectIn, false); }
