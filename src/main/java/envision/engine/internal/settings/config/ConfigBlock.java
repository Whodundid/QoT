package envision.engine.internal.settings.config;
...
public class ConfigBlock {
    ...
    protected BoxList<String, List<String>> blockContents;
    protected boolean createEmptyLine = false;
    
    public ConfigBlock() { blockContents = new BoxList<String, List<String>>().setAllowDuplicates(true); }
    public ConfigBlock(BoxList<String, List<String>> elementsIn) { blockContents = elementsIn; }
    ...
    public BoxList<String, List<String>> getBlockContents() { return blockContents; }
