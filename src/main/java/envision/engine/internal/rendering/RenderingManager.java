...
public class RenderingManager {
    ...
    /** Draws a toString representation of an object at the specified position. */
    ...
    /** Draws the toString representation of an object centered at the specified position. */
    ...
    /** Draws the toString representation of an object at the specified position with shadowing. */
    public static double drawStringS(Object text, double x, double y) { return drawString_i(text, x, y, 1.0, 1.0, 0xffffffff, false, true); }
    ...
    public static double drawStringS(Object text, double x, double y, double scaleX, double scaleY) { return drawString_i(text, x, y, scaleX, scaleY, 0xffffffff, false, true); }
    ...
    /** Draws the toString representation of an object centered at the specified position with shadowing. */
    ...
    public static double drawStringCS(Object text, double x, double y, double scaleX, double scaleY) { return drawString_i(text, x, y, scaleX, scaleY, 0xffffffff, true, true); }
    ...
    /** The internal 'draw string' method that actually gets sent to the string output formatter. */
    ...
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th) {
        drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, 0xffffffff, false); }
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, boolean flip) {
        drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, 0xffffffff, flip); }
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, EColors color) {
        drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color.intVal, false); }
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, EColors color, boolean flip) {
        drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color.intVal, flip); }
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, int color, boolean flip) {
        drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color, Rotation.UP, flip); }
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, int color, Rotation rotation, boolean flip) {
        if (texture == null) return;
        
        if (BatchManager.isEnabled()) BatchManager.drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color, rotation, flip);
        //else GLObject.drawTexture(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color);
    }
