...
//    
    ...
    public static void drawTexture(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, int color, Rotation rotation, boolean flip) {
        instance().drawTexture_i(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color, rotation, flip);
    }
    ...
    protected void drawTexture_i(GameTexture texture, double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double tx, double ty, double tw, double th, int color, Rotation rotation, boolean flip) {
        drawTexture_batch(texture, x0, y0, x1, y1, x2, y2, x3, y3, tx, ty, tw, th, color, flip); }
    ...
    private void drawTexture_batch(
        GameTexture texture,
        double x0, double y0,
        double x1, double y1,
        double x2, double y2,
        ...
        curBatch.vert((float) x0, (float) y0, 0f, r, g, b, f, draw_tsx, draw_tsy, tID);
        curBatch.vert((float) x1, (float) y1, 0f, r, g, b, f, draw_tsx, draw_tey, tID);
        curBatch.vert((float) x2, (float) y2, 0f, r, g, b, f, draw_tex, draw_tey, tID);
        curBatch.vert((float) x3, (float) y3, 0f, r, g, b, f, draw_tex, draw_tsy, tID);
