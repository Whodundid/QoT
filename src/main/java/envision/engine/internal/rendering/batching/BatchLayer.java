...
import envision.engine.internal.rendering.GLSettings;
...
//        var s = EStringUtil.toString(batches, b -> b.isClosed, ", ");
//        System.out.println(this.layerNum + " : " + size + " : " + s);
        ...
        for (int i = 0; i < size; i++) {
            ...
            // if not scissoring
            else if (batch.hasRoomOnLayerIndex(index)) {
    ...
    public void resetLayer() {
        isClosed = false;
        batches.forEach(RenderBatch::resetBatch);
    }
