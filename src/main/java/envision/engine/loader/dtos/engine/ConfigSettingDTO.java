...
public record ConfigSettingDTO(String name, String description, String datatype, String defaultValue) implements IDataTransferObject<ConfigSetting> {    
    //==============
    // Constructors
    //==============
    ...
    @Override
    public ConfigSetting<?> fromDto() throws Exception {
