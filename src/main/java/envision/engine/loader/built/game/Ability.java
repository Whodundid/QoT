...
public class Ability implements IEngineResource {
    ...
    /** @return True if the ability was used by the entity. */
    public boolean use(Entity e, int tierIn) { return false; }
    
    public boolean canEntityUse(Entity e, int tierIn) { return false; }
    
    public boolean canEntityUpgrade(Entity e) { return false; }
