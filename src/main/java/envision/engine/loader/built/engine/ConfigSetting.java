package envision.engine.loader.built.engine;
...
import envision.engine.internal.settings.config.setting_types.ByteConfigSetting;
import envision.engine.internal.settings.config.setting_types.CharConfigSetting;
import envision.engine.internal.settings.config.setting_types.DoubleConfigSetting;
import envision.engine.internal.settings.config.setting_types.EnumConfigSetting;
import envision.engine.internal.settings.config.setting_types.FloatConfigSetting;
import envision.engine.internal.settings.config.setting_types.IntegerConfigSetting;
import envision.engine.internal.settings.config.setting_types.LongConfigSetting;
import envision.engine.internal.settings.config.setting_types.ShortConfigSetting;
...
import envision.engine.loader.dtos.engine.ConfigSettingDTO;
import eutil.EUtil;
...
public class ConfigSetting<T> implements IEngineResource {
    ...
    public ConfigSetting<T> setValidOptions(T... argsIn) { validOptions.addA(argsIn); return this; }
