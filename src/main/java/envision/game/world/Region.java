    ...
    protected synchronized void onEntityEntered(Entity in, double xPos, double yPos) {
        ...
        if (in == Envision.thePlayer) {
            //if (world.getWorldName().equals("new")) {
                if (name.equals("Cave")) {
                    Envision.loadWorld(new File(CurrentGame.getEditorWorldsDir(), "cave/cave.twld"));
                    //Envision.theWorld.setUnderground(true);
                }
                else if (name.equals("MountainPass")) {
                    Envision.loadWorld(new File(CurrentGame.getEditorWorldsDir(), "mountains/mountains.twld"));
                }
                else if (name.equals("Mine")) {
                    Envision.loadWorld(new File(CurrentGame.getEditorWorldsDir(), "mountain_dung/mountain_dung.twld"));
                }
                else if (name.equals("toRuins")) {
                    Envision.loadWorld(new File(CurrentGame.getEditorWorldsDir(), "test/test.twld"));
                }
            //}
            else if (name.equals("exitCave")) {
                Envision.loadWorld(new File(CurrentGame.getEditorWorldsDir(), "new/new.twld"));
            }
