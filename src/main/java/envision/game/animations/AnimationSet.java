...
public class AnimationSet {
    ...
    public void fromSpriteSheet(SpriteSheet sheet) { fromSpriteSheet(sheet, 0, sheet.getNumberOfSprites()); }
    public void fromSpriteSheet(SpriteSheet sheet, int start, int end) {
        for (int i = start; i < end; i++) {
            addFrame(sheet.getSprite(i));
        }
    }
    
    public void fromSpriteSheet(SpriteSheet sheet, int... indices) {
        for (int i : indices) {
            addFrame(sheet.getSprite(i));
        }
    }
