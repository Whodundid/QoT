...
public class OptionsScreen extends GameScreen {
    ...
    public void initChildren() {
        ...
        volumeSlider.setSliderValue(EngineSettings.musicVolume.get());
    ...
    private void animatedMainMenu() {
        CurrentGame.getGameSettings().getSettingByName("animatedMainMenu").toggle();
        CurrentGame.saveGameConfig();
    }
