...
public class MainMenuScreen extends GameScreen {
    ...
    private void loadMenuWorld() {
        ...
        String[] maps = CurrentGame.getEditorWorldsDir().list();
        if (maps.length > 0) {
            ...
            Runnable loader = () -> {
                ...
                world = new GameWorld(new File(CurrentGame.getEditorWorldsDir(), selected));
...
//        drawString(s, 300, 300);
    ...
    private void drawBackground(float dt) {
        ...
        if (secret) {
            drawTexture(EngineTextures.noscreens);
        }
