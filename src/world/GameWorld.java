...
public class GameWorld {
	...
	public synchronized boolean loadWorld() { return loadWorldFromFile(new File(QoT.settings.getEditorWorldsDir(), name)); }
	public synchronized boolean loadWorldFromFile(File worldFile) {
		...
		worldFile = new File(QoT.settings.getEditorWorldsDir(), worldName);
	...
	public File getWorldFile() { return new File(QoT.settings.getEditorWorldsDir(), name); }
