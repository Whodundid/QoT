...
public class WorldSelectScreen extends GameScreen {
	...
	public void initObjects() {
		...
		lastEditor = new WindowButton(this, midX - w / 2, loadWorld.endY + 5, w, 45, QoT.settings.lastMap.get());
	...
	public void actionPerformed(IActionObject object, Object... args) {
		if (object == defaultWorld) {
			File f = new File(QoT.settings.getEditorWorldsDir(), "test.twld");
			if (f.exists()) {
		...
		if (object == lastEditor) {
			String last = QoT.settings.lastMap.get();
