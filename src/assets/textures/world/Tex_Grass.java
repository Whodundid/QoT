...
public class Tex_Grass extends GameTexture {
	...
	public Tex_Grass() {
		super("Grass_0", "resources/textures/world/grass/grass_0.png");
		
		addChild(grass_1 = new GameTexture("Grass_1", "resources/textures/world/grass/grass_1.png"));
		addChild(grass_2 = new GameTexture("Grass_2", "resources/textures/world/grass/grass_2.png"));
