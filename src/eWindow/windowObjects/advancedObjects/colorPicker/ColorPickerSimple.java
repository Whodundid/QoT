package eWindow.windowObjects.advancedObjects.colorPicker;

import eWindow.windowObjects.actionObjects.WindowButton;
import eWindow.windowObjects.actionObjects.WindowTextField;
import eWindow.windowObjects.basicObjects.WindowContainer;
import eWindow.windowObjects.basicObjects.WindowLabel;
import eWindow.windowObjects.basicObjects.WindowRect;
import eWindow.windowObjects.windows.WindowDialogueBox;
import eWindow.windowObjects.windows.WindowDialogueBox.DialogueBoxTypes;
import eWindow.windowTypes.ActionWindowParent;
...
public class ColorPickerSimple<E> extends ActionWindowParent<E> {
	...
	public void initObjects() {
		...
		double y = colorContainer.startY + 4;
		double w = 11;
		double h = 11;
