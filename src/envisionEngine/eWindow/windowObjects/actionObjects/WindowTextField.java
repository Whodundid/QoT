package envisionEngine.eWindow.windowObjects.actionObjects;
...
public class WindowTextField<E> extends ActionObject<E> {
	...
	public void drawObject(int mX, int mY) {
		...
		drawString(drawText, startX + 5, endY - FontRenderer.FONT_HEIGHT + 3);
			...
			//}
				...
				default:
					if (isEnabled() && Keyboard.isTypable(typedChar, keyCode)) {
						typedChar = (Keyboard.isShiftDown()) ? Character.toUpperCase(typedChar) : typedChar;
